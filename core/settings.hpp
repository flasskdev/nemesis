...
struct combat
{
    ...
    struct antiaim
    {
        ...
        config::val<float> spin_speed{ 30.0f, "anti aim", "spin speed" };
...
struct esp
{
    ...
    struct player
    {
        struct overlay
        {
            ...
            overlay( ) = default;
            overlay( const char* prefix )
                : overlay{ std::string{ prefix }, true }
            {
            }
            overlay( const char* prefix, bool enabled_default )
                : overlay{ std::string{ prefix }, enabled_default }
            {
            }
            overlay( const std::string& prefix, bool enabled_default = true )
        ...
        std::array<overlay, 2> m_overlay{ overlay{ "esp enemy", true }, overlay{ "esp team", false } };
...
struct movement
{
    enum class strafe_mode : std::uint8_t
    {
        viewangles,
        directional,
        rage
    ...
    config::enm<strafe_mode> airstrafe_mode{ strafe_mode::viewangles, "movement", "strafe mode" };
    config::val<float> airstrafe_smooth{ 100.0f, "movement", "strafe speed" };
    xui::setting airstrafe_fully_directional{ false, {}, "fully directional", "movement - airstrafe" };
    xui::setting jumpbug{ false, {}, "jumpbug", "movement" };
