...
namespace features::movement {
	...
	void test_strafer::quantized_path(systems::input::usercmd* cmd)
	{
		...
		// ИСПРАВЛЕНИЕ: Используем клиентские углы обзора (systems::g_input.get_view_angles().y),
		// чтобы квантованный стрейфер рассчитывал разгон по реальному направлению мыши игрока,
		// а не по модифицированным Anti-Aim углам из base->viewangles()->y().
